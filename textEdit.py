...
class TextEdit(QWidget):
    def __init__(self):
        ...
        undu_button = QPushButton("Undo")
        undu_button.clicked.connect(self.text_edit.undo)
        ...
        h_layout.addWidget(undu_button)
    ...
    def set_plain_text(self):
        self.text_edit.setPlainText("Some shity text")

    def set_html(self):
        self.text_edit.setHtml("<h1>Some Shity Title</h1>")
